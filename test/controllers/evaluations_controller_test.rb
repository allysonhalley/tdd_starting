...
class EvaluationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evaluation" do
    assert_difference('Evaluation.count') do
      post evaluations_url, params: { evaluation: { comments: @evaluation.comments, movie_id: @evaluation.movie_id, rating: @evaluation.rating } }
    end
  ...
  test "should update evaluation" do
    patch evaluation_url(@evaluation), params: { evaluation: { comments: @evaluation.comments, movie_id: @evaluation.movie_id, rating: @evaluation.rating } }
